...
class plotter:
    ...
    def plot_mse_with_increasing_monitor_training(self, total_edge_mse_list_with_increasing_monitors):
        ...
        fig = plt.figure(figsize=(10, 7))
        plt.plot(x,total_edge_mse_list_with_increasing_monitors[0],label='2')
        plt.plot(x,total_edge_mse_list_with_increasing_monitors[1], label='4')
        plt.plot(x, total_edge_mse_list_with_increasing_monitors[2], label='6')
        plt.plot(x, total_edge_mse_list_with_increasing_monitors[3], label='8')
        plt.plot(x, total_edge_mse_list_with_increasing_monitors[4], label='10')
        #plt.plot(x, total_edge_mse_list_with_increasing_monitors[9], label='100%')
        plt.legend()
        plt.xlabel("time")
        plt.ylabel("total mse of all edges' delay")
    ...
    def plot_edge_computed_during_training(self, G,average_computed_edge_during_training):
        ...
        plt.bar(bar, y, width=barwidth)
        # plt.show()
        plt.savefig(self.directory + 'MAB_edge_computed_with_increasing_monitors_20_ba_nodes.png')
