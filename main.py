...
class main:
    ...
    def run_path_selection(self, G, monitors):
        ...
        rewards_mse_list, selected_shortest_path, expo_count,total_mse_array,total_mse_optimal_edges_array, average_computed_edge_num, optimal_path_selected_rate, avg_diff_of_delay_from_optimal,average_probing_links_origin, average_probing_links_reduced, rate_of_optimal_actions_list, path_oscilation_list,traffic_overhead_every_200_iterations  = self.bound_NT_path_selection.training(G, self.time,monitor_pair_list)
...
mynetwork.logger_main.info("std: std probing links in reduced selected path:")
