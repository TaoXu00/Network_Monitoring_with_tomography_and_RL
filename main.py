...
class main:
    ...
    def MAB_with_increasing_monitors(self, G, type, node_num, p, llc_factor):
        ...
        #for m_p in [20, 30]:
            ...
            self.logger_main.info("percentage of the optimal path selected: %f" % (optimal_path_selected_rate))
            self.logger_main.info(" abs diff from the real optimal path: %f" %(average_optimal_path_selected_rate_among_monitor_pairs))
...
multi_avg_percentage_of_select_optimal_path_among_monitors=np.array(multi_times_optimal_path_selected_percentage_among_monitors_array,axis=0)
